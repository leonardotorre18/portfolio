    ...
    <div className='bg-LightModeWhite-50 dark:bg-DarkModeDarkGrey-50 p-10 w-10/12 mx-auto rounded-xl'>
      ...
      <div className="relative w-full">
        <div className='h-full md:w-1/2 w-full'>
          <img className="object-cover w-full" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/1200px-Unofficial_JavaScript_logo_2.svg.png" alt="" />
        </div>
